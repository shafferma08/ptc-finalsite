...
const TRANSLATIONS = {
    es: {
        ...
        "hub.h1": "Apoyo para estudiantes y familias de PTC",
        "hub.intro": "Ayuda local del condado de Pinellas para estudiantes y familias. Los números de crisis y los contactos de PTC están en la parte superior de la página.",
        ...
        "hub.choose.h2": "Encuentra ayuda",
        "hub.choose.lede": "Explora agencias locales del condado de Pinellas. Filtra por quién necesita ayuda y por el tipo de ayuda que buscas.",
        ...
        "hub.choice1.title": "Encuentra ayuda en la comunidad",
        "hub.choice1.body": "Un directorio buscable de agencias locales del condado de Pinellas. Filtra por quién necesita ayuda (una persona con discapacidad, una familia multilingüe, una persona que estuvo encarcelada, un joven en cuidado de crianza) y por el tipo de ayuda (empleo, educación, consejería, transporte, dinero y más).",
        ...
        "dir.intro": "Agencias locales del condado de Pinellas que apoyan a estudiantes con discapacidades, familias multilingües, personas que estuvieron encarceladas y jóvenes en cuidado de crianza. Elige una población y una necesidad para filtrar la lista.",
