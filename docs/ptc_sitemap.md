...
```mermaid
graph TB
    subgraph "Main Site — myptc.edu"
        M_HOME["🏠 Homepage"]
        M_PROG["📚 Programs Directory"]
        M_ADM["🎓 Admissions"]
        M_FIN["💰 Tuition & Aid"]
        M_ABOUT["🏛 About PTC"]
        M_COMM["🤝 Community"]
        M_RES["🧑‍🎓 Student Resources"]
        M_CONTACT["📞 Contact"]
        M_COMPLY["📋 Consumer Info"]
    end

    subgraph "Clearwater — clearwater.myptc.edu"
        CW_HOME["🏠 CW Homepage"]
        CW_PROG["📚 CW Programs"]
        CW_ADM["🎓 CW Admissions"]
        CW_FIN["💰 CW Tuition"]
        CW_CPL["📊 CW CPL Data"]
        CW_ABOUT["🏛 CW About"]
        CW_CAREER["💼 CW Career Center"]
    end

    subgraph "St. Pete — stpete.myptc.edu"
        SP_HOME["🏠 SP Homepage"]
        SP_PROG["📚 SP Programs"]
        SP_ADM["🎓 SP Admissions"]
        SP_FIN["💰 SP Tuition"]
        SP_CPL["📊 SP CPL Data"]
        SP_ABOUT["🏛 SP About"]
        SP_CAREER["💼 SP Career Center"]
    end
