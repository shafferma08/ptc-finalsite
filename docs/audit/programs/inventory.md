...
2. **Apprenticeships — full pages or a hub?** 13 apprenticeships, mostly thin. Recommend a single Apprenticeships hub per campus (or one institutional page) rather than 13 template builds. IA-Recommender to decide.
