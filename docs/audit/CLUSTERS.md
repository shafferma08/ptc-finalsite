...
| 2 | About sub-pages | `queued` | (12 sub-pages across 3 hubs — Code of Conduct STP, Written Plans CLW+STP, Financial Accountability CLW+STP, School Improvement Plan CLW+STP, Safety & Security Data CLW+STP, M/V/CV ×3, A Career in a Year, Get to Know PTC, Programs Brochure EN+ES, Records Request ×3, Annual Impact Report, PCS/CTAE Compliance Statements, PCS School Financial Reports, Sexual Misconduct/Predators) | Decision pending in IA stage. Likely: Compliance lands in compliance cluster, Records lands in records-request.html, M/V/CV embedded in about.html, Brochure becomes a downloads/resources entry. | — | **Run this next.** Per Marianne (2026-04-27): finish About fully before moving on. Several items have `follow-ups.md` entries — those drive live-site owner asks but redesign uses verbatim live for now. |
